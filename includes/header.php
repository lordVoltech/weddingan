                    ...
                    <div class="relative" x-data="{ userMenuOpen: false }">
                        ...
                        <div x-show="userMenuOpen"
                            ...
                            <div class="px-4 py-2 border-b border-gray-200 dark:border-gray-700">
                                <p class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo isset($_SESSION['name']) ? $_SESSION['name'] : 'User Account'; ?></p>
                                <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo isset($_SESSION['email']) ? $_SESSION['email'] : ''; ?></p>
                            </div>
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 mt-2 pt-2">
                                <a href="logout.php" class="block px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
