...
<head>
  ...
  <meta name="google-signin-client_id" content="468756575892-ev53i0f1hfjdg180lo82q2pr545g95ae.apps.googleusercontent.com">

  <title>NUVA - Login </title>
  <link rel="stylesheet" href="style.css"> <!-- Pastikan file CSS-mu bernama style.css atau ganti sesuai -->
    ...
    <form action="login.php" method="POST" class="log-in" autocomplete="off">
      ...
      <script>
        function onSignIn(googleUser) {
          ...
          // Dapatkan ID token untuk dikirim ke server untuk validasi
          var id_token = googleUser.getAuthResponse().id_token;

          // Kirim token ke server
          var xhr = new XMLHttpRequest();
          xhr.open('POST', 'validate_token.php');
          xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
          xhr.onload = function() {
            console.log('RESPONSE: ' + xhr.responseText);
            if (xhr.responseText.includes("success")) {
              window.location.href = 'http://localhost/llogin/src/dashboard.php';
            } else {
