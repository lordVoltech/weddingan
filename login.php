...
<body>
  <div class="session">
    ...
    <form action="auth.php" method="POST" class="log-in" autocomplete="off">
      <h4>We are <span>NUVA</span></h4>
      <p>Welcome back! Log in to your account to view today's clients:</p>
      <div class="floating-label">
        <input value="<?= htmlspecialchars($emailValue) ?>" placeholder="Email" type="email" name="email" id="email" autocomplete="off">
